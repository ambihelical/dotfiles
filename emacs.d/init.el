...
(use-package dired
  ...
  (eval '(defhydra hydra-dired (:hint nil :color pink)
      ...
      ("y" diredp-relsymlink-this-file "Rsymlink .")
      ("Y" dired-do-relsymlink "Rsymlink +")
      ("% Y" dired-do-relsymlink-regexp "Rsymlink Re")
      ("M-+ Y" diredp-do-relsymlink-recursive "Rsymlink /")
      ("S" dired-do-symlink "Symlink +")
      ("% S" dired-do-symlink-regexp "Symlink Re")
      ("M-+ S" diredp-do-symlink-recursive "Symlink /")
      ...
      ("M-M" diredp-chmod-this-file "Chmod .")
      ("M-+ M" diredp-do-chmod-recursive "Chmod /")
      ("O" dired-do-chown "Chown +")
      ("M-O" diredp-chown-this-file "Chown .")
      ("M-+ O" diredp-do-chown-recursive "Chown /")
      ("G" dired-do-chgrp "Chgrp +")
      ("C-M-G" dired-chgrp-this-file "Chgrp .")
      ("M-+ G" dired-do-chgrp-recursive "Chgrp /")
